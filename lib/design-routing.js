...
const BIOMEDICAL_CONTEXT_PATTERN = /抗体|抗原|靶点|表位|蛋白|细胞|受体|配体|通路|疾病|治疗|肿瘤|癌|哮喘|过敏|炎症|自身免疫|类风湿|关节炎|感染|病原|细菌|真菌|病毒|疫苗|免疫|生物|分子|植物病原|肥胖|糖尿病|银屑病|阿尔茨海默|代谢|pd-1|pd-l1|il-33|st2|her2|erbb2|tnf|egfr|vegf|cd3|cd20|bcma|biolog|biomedical|therapeutic|tumou?r|cancer|asthma|allergy|inflammation|autoimmune|infection|pathogen|bacteria|fungal|viral|antigen|target|epitope|protein|receptor|ligand|immune|vaccine|antibody/;
